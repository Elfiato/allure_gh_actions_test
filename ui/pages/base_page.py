...
class BasePage:
    ...
    def get_present_element(self, how, what, timeout=WAITING_TIME):
    ...
    def get_clickable_element(self, how, what, timeout=WAITING_TIME):
        logger.info(f'Getting element with locator: {how}: {what}.')
        return self.wait(timeout).until(EC.element_to_be_clickable((how, what)))

    def get_visible_element(self, how, what, timeout=WAITING_TIME):
        logger.info(f'Getting element with locator: {how}: {what}.')
    ...
    def is_element_visible(self, how, what, timeout=WAITING_TIME):
        logger.info(f'Checking is element visible with locator: {how}: {what}.')
        try:
